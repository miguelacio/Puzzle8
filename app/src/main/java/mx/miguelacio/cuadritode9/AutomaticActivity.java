...
public class AutomaticActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gridAdapter = new PuzzleAdapter(cells, AutomaticActivity.this);
        ...
        int [][] secondinital = {{1,2,3}, {4,5,6}, {0,7,8}};
        int[][] goal = { {1, 2, 3}, {4, 5, 6}, {7, 8, 0} };


        if (isSolvable(secondinital)) {
            solve(secondinital, goal, 2, 0);
        }
        else {
        ...
        ArrayList<ArrayList<Cell>> pasos = board.getPasos();
        ...
        for (int i = 0; i < pasos.size(); i++) {
            ...
            final Runnable r = new Runnable() {
                ...
                public void run() {
                    ...
                    gridAdapter = new PuzzleAdapter(pasos.get(finalI), AutomaticActivity.this);
